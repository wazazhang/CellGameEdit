...
//---------------------------------------------------------------------------------------------------------------------------------------------
        ...
        public static int getDirect(float s)
        {
            return (int)(s == 0 ? 0 : s > 0 ? Math.Max(1, s) : Math.Min(-1, s));
        }
	...
	static public double defaultAngle(double degree)
	{
        ...
        static public bool intersect1D(
			float sx1, float sx2,  
			float dx1, float dx2) 
        {
        ...
        static public bool intersect2D(
        ...
        static public bool intersect2DWH(
        ...
        public static ArrayList ToArrayList<T>(List<T> list)
        {
        ...
        public static List<T> ToGenericList<T>(ArrayList list)
        {
            List<T> ret = new List<T>();
            for (int i = 0; i < list.Count; i++)
            {
                T d = (T)System.Convert.ChangeType(list[i], typeof(T));
                ret.Add(d);
            }
            return ret;
        }
